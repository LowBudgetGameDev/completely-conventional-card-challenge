...
{
    public const float GiveInitialCardsDelay = 1.5f; // How long after the scene is loaded will the cards be given
    public const float GiveCardTime = 0.5f; // How long it takes to move a card from deck to hand
